 ...
 */
final class Version20200113090648 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE flight (id INT AUTO_INCREMENT NOT NULL, arrival_id INT NOT NULL, departure_id INT NOT NULL, number VARCHAR(25) NOT NULL, schedule TIME NOT NULL, price INT NOT NULL, reduction TINYINT(1) DEFAULT NULL, seat INT NOT NULL, INDEX IDX_C257E60E62789708 (arrival_id), INDEX IDX_C257E60E7704ED06 (departure_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
